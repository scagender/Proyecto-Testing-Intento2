...
RSpec.describe User, type: :model do
    it "is valid with valid attributes" do
      user = User.new(name: 'Juan', password: 'Nonono123!', email: 'asdf@gmail.com', role: 'admin')
    ...
    it "is not valid without an email" do
      user = User.new(name: 'Juan', password: 'Nonono123!', email: nil, role: 'admin')
      expect(user).to_not be_valid
    end
  
    it "is not valid without a password" do
      user = User.new(name: 'Juan', email: 'asdf@gmail.com', password: nil, role: 'admin')
      expect(user).to_not be_valid
    end
    ...
    it "is not valid with a duplicate email" do
      user1 = User.create!(name: 'Juan', password: 'Nonono123!', email: 'asdf@gmail.com', role: 'admin')
    ...
    describe "Methods" do
      it "has a valid password_required? method" do
        user = User.new(name: 'Juan', email: 'asdf@gmail.com', role: 'admin')
