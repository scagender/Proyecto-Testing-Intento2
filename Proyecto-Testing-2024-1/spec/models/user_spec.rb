...
RSpec.describe User, type: :model do
  ...
  it 'has many reviews' do
    @product = Product.create!(nombre: 'Producto de prueba', precio: 4000, stock: 1, categories: 'Cancha', user: @user)
    @review1 = Review.create(tittle:"Buen producto", description: "Me gustó mucho", calification: 5, user: @user, product: @product)
    @review2 = Review.create(tittle:"Decente", description: "No me gustó tanto", calification: 3,  user: @user, product: @product)
